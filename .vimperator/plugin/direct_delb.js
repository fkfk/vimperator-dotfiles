...
(function(){
    ...
    commands.addUserCommand(['delbtags'],"Update DeliciousBookmark Tags", getTags, {});
    commands.addUserCommand(['delb'],"Post to DeliciousBookmark",
        function(arg){
            addDeliciousBookmarks(buffer.URL, buffer.title, arg, isNormalize);
        },{
